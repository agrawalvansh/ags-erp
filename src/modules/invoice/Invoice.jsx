...
const Invoice = () => {
  ...
  // Load invoice items (default or from InvoiceData based on route param)
  useEffect(() => {
    let processedData = [];
        ...
        <div className="p-3 sm:p-6 border-b">
          <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
            ...
            <div className="text-left lg:text-right w-full lg:w-auto">
              <h2 className="text-lg sm:text-2xl font-bold text-[#05014A]">Tax Invoice</h2>
              <p className="mt-2 text-sm sm:text-base">Invoice No: INV-000232</p>
          ...
          <table className="w-full min-w-[700px]">
            ...
            <tbody>
              ...
              <tr className="border-b bg-gray-50">
                <td className="p-2 sm:p-3 text-sm">{invoiceItems.length + 1}.</td>
                <td className="p-2 sm:p-3">
