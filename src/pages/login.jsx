...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#caf0f8] flex flex-col">
      ...
      <div className="bg-[#05014A] text-[#caf0f8] py-2 overflow-hidden relative">
        <motion.div
        ...
        >
          🔐 Login Credentials: Username: "{ENV_USERNAME}" | Password: "{ENV_PASSWORD}" | Note: Any credentials will work for Demo Purposes 🔐
        </motion.div>
      </div>
          ...
          <div className="flex-1 p-8 md:p-12 max-w-md mx-auto">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Demo Notice */}
                <div className="bg-[#caf0f8]/30 border border-[#05014A]/20 rounded-lg p-3">
                  <p className="text-xs text-[#05014A]/70 text-center">
